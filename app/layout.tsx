...
export const metadata: Metadata = {
  title: "Moveup — Fitness that fits student life.",
  description:
    "Moveup motivates students through friends, fits fitness into their timetable, and guides them to the best place and time to stay active.",
  manifest: "/manifest.json",
  appleWebApp: { capable: true, statusBarStyle: "default", title: "Moveup" },
  icons: {
